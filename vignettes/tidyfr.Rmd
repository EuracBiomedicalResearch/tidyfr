...
The Textual Dataset File Format (TDFF; sometimes referred to also as Textual
Dataset Format) is a file format to store data from biomedical experiments in
simple text files which enables easier extension, storage and editing. A
detailed description of the format is provided
